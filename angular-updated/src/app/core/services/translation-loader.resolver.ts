...
export class TranslationLoaderResolver implements Resolve<any> {
  ...
  resolveTranslation(lang: string, source: Array<string>): Observable<any> {
    const key: string = source.join() + lang;
    ...
    if (this.translations[key]) {
      ...
      return loader.getTranslation(lang).pipe(map((trans: any[]) => {
